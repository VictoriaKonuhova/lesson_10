...
let lang = "ru";
let arr;
let ru_arr = ["пн", "вт", "ср", "чт", "пт", "сб", "вс"];
let en_arr = ["mn", "ts", "wd", "th", "fr", "st", "sn"];
if (lang == "ru") {
  console.log((arr = ru_arr));
} else if (lang == "en") {
  console.log((arr = en_arr));
} else {
